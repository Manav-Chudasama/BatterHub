  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <motion.aside
        ...
        className="fixed top-0 left-0 h-screen border-r border-black/[.08] dark:border-white/[.08] bg-white dark:bg-black z-50"
      >
        {/* Logo */}
      ...
      >
        {/* Top Bar */}
        <div className="sticky top-0 z-40 h-16 bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-black/[.08] dark:border-white/[.08]">
